...
public abstract class SubfieldHandlerCore<
                        S extends OperationSettings,
                        TD extends DefinitionSegment<?,?>,
                        NC extends SubcomponentHandlerCore<?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?>,
                        K extends FieldSegment<?,?,?>,
                        KC extends FieldCore<?,?,?,?,?,?,? extends K,?,?>,
                        J extends SubfieldHandler<?>,
                        AOC extends PacketOperationSegmentCore<?,?,?,?,AD,?,?,?,?,?,?>,
                        AD extends DefinitionSegment<?,?>>
    implements SubfieldHandler<K>,
               Initializable,
               Resetable
{
  ...
  public final Optional<OperationSegment<?,?,?,?,?>> processBytestream() {
    return this.packetFieldCore.processSingleStepBytestream();
  }

  protected abstract TD definition();

  protected abstract ComponentSegment<? extends TD> protocolField();

  public abstract ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> protocolFieldCore();
