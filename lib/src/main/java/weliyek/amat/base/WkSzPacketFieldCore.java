               ...
               WkSzPacketField<T,O,D>
{
    ...
    protected Optional<WkSzPacketOperation<?, ?, ?, ?, ?>> processSingleStepBytestream() {
      throwIfUnitialized();
      if (isCompleted()) {
        return Optional.empty();
      }
      Optional<WkSzPacketOperation<?, ?, ?, ?, ?>> opCompleted = this.operationListManager.processingBytestream();
      if (isCompleted()) {
