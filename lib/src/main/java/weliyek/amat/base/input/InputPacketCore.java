...
public final class InputPacketCore<
                        T,
                        XS extends OperationSettings,
                        XD extends DefinitionSegment<T,?>,
                        XO extends DeserializingOperation<T,XS,?,? extends DeserializingResult<T>,XD>,
                        AXBC extends InputBytestreamGeneralBase<?>>
    extends DeserializingFieldCore<
                        T, XS, XD, XO, AXBC,
                        AggregatorReading<?,?,? extends DeserializingRuntime<?>,?,?>>
    implements InputPacket<T, XD, XO>
{
...
public Optional<OperationSegment<?,?,?,?,?>> previousProcessingSteapResult() {
  ...
  */
  ...
  @Override
  protected AggregatorReadingCore<?,?,?,AXBC,?,?,?,?,AggregatorReading<?,?,? extends DeserializingRuntime<?>,?,?>,?,?,?>
  parentOperationCore() {
    return null;
  }
   ...
   */
  @Override
  public InputPacket<T, XD, XO> asPacket() {
    return this;
  }
