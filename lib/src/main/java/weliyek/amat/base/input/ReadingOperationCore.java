...
public abstract class ReadingOperationCore<
                        T,
                        XS extends OperationSettings,
                        XQ extends DeserializingRuntime<?>,
                        XQC extends ReadingRuntimeControl<?,?,XQ>,
                        XR extends DeserializingResult<T>,
                        XO extends DeserializingOperation<T,XS,XQ,XR,XD>,
                        XOC extends ReadingOperationCore<T,XS,XQ,XQC,XR,XO,?,XD,AXB,DC>,
        ...
        extends PacketOperationSegmentCore<
                        ...
                        DeserializingFieldCore<T,?,XD,?,?,?>>
        implements DeserializingOperation<T, XS, XQ, XR, XD>
{

    private final XQC runtime;

    protected ReadingOperationCore(
      int index,
      XS settings,
      AXB parentBytestream,
      DeserializingFieldCore<T,?,XD,?,?,?> packetField,
      DC definitionCore,
      XO operationBody) {
