...
public class SubcomponentHandlerCore<
                        ST,
    ...
    implements SubcomponentHandler<XO, YO, SD>
{
  ...
  private final ComponentSegmentCore<ST,SXS,SXD,SXO,XBC,SYS,SYD,SYO,YBC,SD> protocolfieldCore;
  private final SubcomponentHandler<XO, YO, SD> body;
  private final Disaggregator<ST, SYD, T, YO> disaggregator;
  private boolean deserializedRequiredByAggregator;
  private int order;

  SubcomponentHandlerCore(
    String label,
    ...
    this.body = new SubcomponentHandler<XO, YO, SD>() {

      @Override
      public Optional<Predicate<? super XO>> rxOptionalityTest() {
        return SubcomponentHandlerCore.this.rxOptionalityTest();
      }

      @Override
      public Optional<Predicate<? super YO>> txOptionalityTest() {
        return SubcomponentHandlerCore.this.txOptionalityTest();
      }

      @Override
      public ToIntFunction<? super XO> numberOfRxOperationsEvaluator() {
        return SubcomponentHandlerCore.this.numberOfRxOperationsEvaluator();
      }

      @Override
      public ToIntFunction<? super YO> numberOfTxOperationsEvaluator() {
        return SubcomponentHandlerCore.this.numberOfTxOperationsEvaluator();
      }

      @Override
      public ComponentSegment<SD> field() {
        return SubcomponentHandlerCore.this.field();
      }

      @Override
      public int executionOrder() {
        return SubcomponentHandlerCore.this.executionOrder();
      }
    };
  }

  @SuppressWarnings("unchecked")
  public SerializingSubfieldHandlerCore<ST,SYS,SYD,SYO,T,YBC,YD,YO>
  newWritingSubfieldHandlerCore(
    AggregatorWritingCore<?,?,?,YBC,?,?,?,YD,YO,?,?,?> writingParentOp) {
    SerializingSubfieldHandlerCore<ST,SYS,SYD,SYO,T,YBC,YD,YO>
      writingSubfieldHandler = new SerializingSubfieldHandlerCore<ST,SYS,SYD,SYO,T,YBC,YD,YO>();
    writingSubfieldHandler.initiliaze(
        (SubcomponentHandlerCore<ST,?,?,?,T,?,?,?,SYS,SYD,SYO,YBC,YD,YO,? extends SYD,? extends YD>) this,
        writingParentOp);
    return writingSubfieldHandler;
  }

  @SuppressWarnings("unchecked")
  public DeserializingSubfieldHandlerCore<ST,SXS,SXD,SXO,T,XBC,XD,XO>
  newReadingSubfieldHandlerCore(
    AggregatorReadingCore<?,?,?,XBC,?,?,?,XD,XO,?,?,?> readingParentOp) {
    DeserializingSubfieldHandlerCore<ST,SXS,SXD,SXO,T,XBC,XD,XO> readingSubfieldHandler = new DeserializingSubfieldHandlerCore<>();
    readingSubfieldHandler.initiliaze(
        (SubcomponentHandlerCore<ST,SXS,SXD,SXO,?,XBC,XD,XO,?,?,?,?,?,?,? extends SXD, ? extends XD>) this, readingParentOp);
  ...
  */
  ...
  public SubcomponentHandler<XO, YO, SD> body() {
    return this.body;
  }

  public final ComponentSegmentCore<ST,SXS,SXD,SXO,XBC,SYS,SYD,SYO,YBC,SD> protocolFieldCore() {
