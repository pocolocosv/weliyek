...
public interface CollectionAndElementsFieldOperation<
                        S extends OperationSettings,
                        Q extends SequenceCommonOperationRuntime<?>,
                        R extends OperationResult,
                        D extends CollectionAndElementsFieldDefinition<?,?,?,?,?>,
                        K extends FieldSegment<?,?,?>,
                        EO extends OperationSegment<?,?,?,?,?>,
                        EK extends FieldSegment<?,EO,?>,
                        EJ extends SubfieldHandler<EK>>
        extends CollectionAndElementsFieldSegment<EJ>,
                CollectionFieldOperation<S, Q, R, D, K>
{
