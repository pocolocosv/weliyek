...
import weliyek.amat.basic.sequence.VariableSizeSequenceSegment;

public interface VariableSizeSequenceDefinition<
                        T,
                        XO extends VariableSizeSequenceReading<T,?,?,?,?>>
        extends VariableSizeSequenceSegment,
