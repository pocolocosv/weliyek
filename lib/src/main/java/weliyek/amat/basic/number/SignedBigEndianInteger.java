...
public class SignedBigEndianInteger
                        ...
                        SignedBigEndianIntegerDeserializing>
{
  ...
  newCore(ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> componentCore) {
    return new SignedBigEndianInteger(componentCore).definitionCore;
  }
  ...
  private final SimplifiedNumberSerializerCore<
                        ...
                        SignedBigEndianIntegerDeserializing,
                        SignedBigEndianIntegerSerializing,
                        SignedBigEndianInteger> definitionCore;

  private SignedBigEndianInteger(
    ...
    this.definitionCore = new SimplifiedNumberSerializerCore<
                                  ...
                                  SignedBigEndianInteger>(
                                      componentCore,
                                      (i,xs,axb,xkc,dc) -> new SignedBigEndianIntegerDeserializing(i,xs,axb,xkc,dc).operationCore,
                                      BigEndianSignedIntegerInputSerialization.FACTORY,
                                      (i,y,ys,ayb,ykc,dc) -> new SignedBigEndianIntegerSerializing(i,y,ys,ayb,ykc,dc).operationCore,
  ...
  @Override
  public FieldTester<?,?>
  makeTester(Predicate<? super SignedBigEndianIntegerDeserializing> test, String description) {
