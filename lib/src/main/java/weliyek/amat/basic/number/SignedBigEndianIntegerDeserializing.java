...
public final class SignedBigEndianIntegerDeserializing
                        ...
                        SignedBigEndianInteger>
{
  ...
  final SimpleNumberReadingCore<
                      ...
                      SignedBigEndianInteger> operationCore;
  ...
  SignedBigEndianIntegerDeserializing(
    ...
    DeserializingFieldCore<
      Integer,?,SignedBigEndianInteger,?,?,?> deserializingfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,SignedBigEndianIntegerDeserializing,?,SignedBigEndianInteger> definitionCore) {
  ...
  @Override
  public DeserializingField<Integer, SignedBigEndianInteger, ?> packetField() {
    return this.operationCore.packet();
  }

  @Override
  public SignedBigEndianInteger definition() {
