...
public final class SignedBigEndianIntegerSerializing
                        ...
                        SignedBigEndianInteger>
{
  ...
  SignedBigEndianIntegerSerializing(
    ...
    SerializingFieldCore<
      Integer,?,SignedBigEndianInteger,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,?,SignedBigEndianIntegerSerializing,SignedBigEndianInteger> definitionCore) {
  ...
  @Override
  public SerializingField<Integer, SignedBigEndianInteger, ?> packetField() {
