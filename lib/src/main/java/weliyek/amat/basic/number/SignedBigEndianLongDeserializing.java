...
public final class SignedBigEndianLongDeserializing
                        ...
                        SignedBigEndianLong>
{
  ...
  final SimpleNumberReadingCore<
                      ...
                      SignedBigEndianLong> operationCore;
  ...
  SignedBigEndianLongDeserializing(
    ...
    DeserializingFieldCore<
      Long,?,SignedBigEndianLong,?,?,?> deserializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,SignedBigEndianLongDeserializing,?,SignedBigEndianLong> definitionCore) {
  ...
  @Override
  public DeserializingField<Long, SignedBigEndianLong, ?> packetField() {
    return this.operationCore.packet();
  }

  @Override
  public SignedBigEndianLong definition() {
