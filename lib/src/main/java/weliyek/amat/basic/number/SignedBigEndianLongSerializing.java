...
public final class SignedBigEndianLongSerializing
                        ...
                        SignedBigEndianLong>
{
  ...
  SignedBigEndianLongSerializing(
    ...
    SerializingFieldCore<
      Long,?,SignedBigEndianLong,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,?,SignedBigEndianLongSerializing,SignedBigEndianLong> definitionCore) {
  ...
  @Override
  public SerializingField<Long, SignedBigEndianLong, ?> packetField() {
