...
public final class SignedBigEndianShortDeserializing
                        ...
                        SignedBigEndianShort>
{
    ...
    final SimpleNumberReadingCore<
                        ...
                        SignedBigEndianShort> operationCore;
    ...
    SignedBigEndianShortDeserializing(
      ...
      DeserializingFieldCore<
        Short,?,SignedBigEndianShort,?,?,?> deserializingfieldCore,
      SimplifiedNumberSerializerCore<
        Short,SignedBigEndianShortDeserializing,?,SignedBigEndianShort> definitionCore) {
    ...
    @Override
    public DeserializingField<Short, SignedBigEndianShort, ?> packetField() {
    ...
    @Override
    public SignedBigEndianShort definition() {
