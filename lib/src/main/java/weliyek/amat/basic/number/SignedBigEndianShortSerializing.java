...
public final class SignedBigEndianShortSerializing
                        ...
                        SignedBigEndianShort>
{
  ...
  SignedBigEndianShortSerializing(
    ...
    SerializingFieldCore<
      Short,?,SignedBigEndianShort,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Short,?,SignedBigEndianShortSerializing,SignedBigEndianShort> definitionCore) {
  ...
  @Override
  public SerializingField<Short, SignedBigEndianShort, ?> packetField() {
