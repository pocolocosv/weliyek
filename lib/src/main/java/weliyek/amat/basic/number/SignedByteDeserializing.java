...
public final class SignedByteDeserializing
                        ...
                        SignedByte>
{
    ...
    final SimpleNumberReadingCore<
                        ...
                        SignedByte> operationCore;

    SignedByteDeserializing(
      int index,
      OperationSettings settings,
      InputBytestreamGeneralBase<?> parentBytestream,
      DeserializingFieldCore<Byte,?,SignedByte,?,?,?> readingfieldCore,
      SimplifiedNumberSerializerCore<
        Byte,SignedByteDeserializing,?,SignedByte> definitionCore) {
      operationCore = new SimpleNumberReadingCore<
                            Byte, SignedByteDeserializing, SignedByte>(
                                index,
                                settings,
                                parentBytestream,
                                readingfieldCore,
    ...
    @Override
    public DeserializingField<Byte, SignedByte, ?> packetField() {
