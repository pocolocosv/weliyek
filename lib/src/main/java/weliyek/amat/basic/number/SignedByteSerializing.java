...
public final class SignedByteSerializing
                    ...
                    SignedByte>
{
  ...
  static SimpleNumberSerializerWritingCore<
                    Byte,
    ...
    SerializingFieldCore<Byte,?,SignedByte,?,?,?> writingfieldCore,
    SimplifiedNumberSerializerCore<
      Byte,?,SignedByteSerializing,SignedByte> defintionCore) {
    return new SignedByteSerializing(
                    index,
                    serializable,
                    settings,
                    parentBytestream,
  ...
  SignedByteSerializing(
    ...
    this.writingCore = new SimpleNumberSerializerWritingCore<
                              Byte, SignedByteSerializing, SignedByte>(
                                    index,
                                    serializable,
                                    settings,
                                    parentBytestream,
  ...
  @Override
  public SerializingField<Byte, SignedByte, ?> packetField() {
