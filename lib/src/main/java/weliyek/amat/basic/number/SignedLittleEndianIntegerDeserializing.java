...
public final class SignedLittleEndianIntegerDeserializing
                        ...
                        SignedLittleEndianInteger>
{
  ...
  final SimpleNumberReadingCore<
                      ...
                      SignedLittleEndianInteger> operationCore;
  ...
  SignedLittleEndianIntegerDeserializing(
    ...
    DeserializingFieldCore<
      Integer,?,SignedLittleEndianInteger,?,?,?> deserializingfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,SignedLittleEndianIntegerDeserializing,?,SignedLittleEndianInteger> definitionCore) {
  ...
  @Override
  public DeserializingField<Integer, SignedLittleEndianInteger, ?> packetField() {
    return this.operationCore.packet();
  }

  @Override
  public SignedLittleEndianInteger definition() {
