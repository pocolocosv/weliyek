...
public final class SignedLittleEndianIntegerSerializing
                        ...
                        SignedLittleEndianInteger>
{
  ...
  SignedLittleEndianIntegerSerializing(
    ...
    SerializingFieldCore<
      Integer,?,SignedLittleEndianInteger,?,?,?> serializationfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,?,SignedLittleEndianIntegerSerializing,SignedLittleEndianInteger> definitionCore) {
  ...
  @Override
  public SerializingField<Integer, SignedLittleEndianInteger, ?> packetField() {
