...
public final class SignedLittleEndianLongSerializing
                        ...
                        SignedLittleEndianLong>
{
  ...
  SignedLittleEndianLongSerializing(
    ...
    SerializingFieldCore<
      Long,?,SignedLittleEndianLong,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,?,SignedLittleEndianLongSerializing,SignedLittleEndianLong> definitionCore) {
  ...
  @Override
  public SerializingField<Long, SignedLittleEndianLong, ?> packetField() {
