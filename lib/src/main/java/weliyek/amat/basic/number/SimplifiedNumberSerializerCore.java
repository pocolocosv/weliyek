...
public final class SimplifiedNumberSerializerCore<
                        T extends Number,
    ...
    extends NumberSerializerCore<
                        ...
                        D,
                        SimplifiedNumberSerializerCore<T,XO,YO,D>>
{

  public SimplifiedNumberSerializerCore(
    ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> componentCore,
    PacketInputFieldReadingFactory<
      T, OperationSettings, D, SimplifiedNumberSerializerCore<T,XO,YO,D>,
  ...
  @Override
  protected SimplifiedNumberSerializerCore<T,XO,YO,D> getThis() {
    return this;
  }
