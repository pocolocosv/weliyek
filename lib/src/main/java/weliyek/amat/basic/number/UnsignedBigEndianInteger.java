...
public class UnsignedBigEndianInteger
    implements NumberDefinition<
                        Long,
                        UnsignedBigEndianIntegerDeserializing>
{

  public static PacketStructure<
                        Long,
                        OperationSettings,
                        UnsignedBigEndianInteger,
                        UnsignedBigEndianIntegerDeserializing,
                        InputBytestreamGeneralBase<?>,
                        OperationSettings,
                        UnsignedBigEndianInteger,
                        UnsignedBigEndianIntegerSerializing,
                        OutputBytestreamGeneralBase<?>,
                        UnsignedBigEndianInteger>
  newPacketStructure(String label) {
    return new PacketStructure<>(
                      label,
                      UnsignedBigEndianInteger::newCore,
  ...
  newCore(ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> componentCore) {
    return new UnsignedBigEndianInteger(componentCore).definitionCore;
  }
  ...
  private final SimplifiedNumberSerializerCore<
                        ...
                        UnsignedBigEndianIntegerDeserializing,
                        UnsignedBigEndianIntegerSerializing,
                        UnsignedBigEndianInteger> definitionCore;

  private UnsignedBigEndianInteger(
    ...
    this.definitionCore = new SimplifiedNumberSerializerCore<
                                  ...
                                  UnsignedBigEndianInteger>(
                                      componentCore,
                                      (i,xs,axb,xkc,dc) -> new UnsignedBigEndianIntegerDeserializing(i,xs,axb,xkc,dc).operationCore,
                                      BigEndianUnsignedIntegerInputSerialization.FACTORY,
                                      (i,y,ys,ayb,ykc,dc) -> new UnsignedBigEndianIntegerSerializing(i,y,ys,ayb,ykc,dc).operationCore,
  ...
  @Override
  public FieldTester<?, ?>
  makeTester(Predicate<? super UnsignedBigEndianIntegerDeserializing> test, String description) {
