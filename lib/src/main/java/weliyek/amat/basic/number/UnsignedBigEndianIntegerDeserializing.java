...
public final class UnsignedBigEndianIntegerDeserializing
                        ...
                        UnsignedBigEndianInteger>
{
  ...
  UnsignedBigEndianIntegerDeserializing(
    ...
    DeserializingFieldCore<
      Long,?,UnsignedBigEndianInteger,?,?,?> deserializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,UnsignedBigEndianIntegerDeserializing,?,UnsignedBigEndianInteger> definitionCore) {
  ...
  @Override
  public DeserializingField<Long, UnsignedBigEndianInteger, ?> packetField() {
