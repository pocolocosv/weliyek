...
public class UnsignedBigEndianIntegerSerializing
                        ...
                        UnsignedBigEndianInteger>
{
  ...
  final SimpleNumberSerializerWritingCore<
                        ...
                        UnsignedBigEndianInteger> operationCore;
  ...
  UnsignedBigEndianIntegerSerializing(
    ...
    SerializingFieldCore<
      Long,?,UnsignedBigEndianInteger,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,?,UnsignedBigEndianIntegerSerializing,UnsignedBigEndianInteger> definitionCore) {
  ...
  @Override
  public UnsignedBigEndianInteger definition() {
  ...
  @Override
  public SerializingField<Long, UnsignedBigEndianInteger, ?> packetField() {
