...
public class UnsignedBigEndianShortSerializing
                        ...
                        UnsignedBigEndianShort>
{
  ...
  final SimpleNumberSerializerWritingCore<
                        ...
                        UnsignedBigEndianShort> operationCore;
  ...
  UnsignedBigEndianShortSerializing(
    ...
    SerializingFieldCore<
      Integer,?,UnsignedBigEndianShort,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,?,UnsignedBigEndianShortSerializing,UnsignedBigEndianShort> definitionCore) {
  ...
  @Override
  public UnsignedBigEndianShort definition() {
  ...
  @Override
  public SerializingField<Integer, UnsignedBigEndianShort, ?> packetField() {
