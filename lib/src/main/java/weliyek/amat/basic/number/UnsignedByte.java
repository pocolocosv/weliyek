                      ...
                      UnsignedByteDeserializing>
{
  ...
  newCore(ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> componentCore) {
    return new UnsignedByte(componentCore).definitionCore;
  }
  ...
  private final SimplifiedNumberSerializerCore<
                        ...
                        UnsignedByteDeserializing,
                        UnsignedByteSerializing,
                        UnsignedByte> definitionCore;

  private UnsignedByte(ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> componentCore) {
    this.definitionCore = new SimplifiedNumberSerializerCore<>(
                                  componentCore,
                                  (i,xs,axb,xkc,dc) -> new UnsignedByteDeserializing(i,xs,axb,xkc,dc).operationCore,
                                  UnsignedByteInputSerialization.FACTORY,
                                  (i,y,ys,ayb,ykc,dc) -> new UnsignedByteSerializing(i,y,ys,ayb,ykc,dc).writingCore,
  ...
  @Override
  public FieldTester<?, ?>
  makeTester(Predicate<? super UnsignedByteDeserializing> test, String description) {
