...
public final class UnsignedIntegerLittleEndianReading
                        ...
                        UnsignedLittleEndianInteger>
{
  ...
  UnsignedIntegerLittleEndianReading(
    ...
    DeserializingFieldCore<
      Long,?,UnsignedLittleEndianInteger,?,?,?> deserializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,UnsignedIntegerLittleEndianReading,?,UnsignedLittleEndianInteger> definitionCore) {
  ...
  @Override
  public DeserializingField<Long, UnsignedLittleEndianInteger, ?> packetField() {
