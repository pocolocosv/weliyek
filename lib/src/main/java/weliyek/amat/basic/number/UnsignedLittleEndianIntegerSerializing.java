...
public class UnsignedLittleEndianIntegerSerializing
                        ...
                        UnsignedLittleEndianInteger>
{
  ...
  final SimpleNumberSerializerWritingCore<
                      ...
                      UnsignedLittleEndianInteger> operationCore;
  ...
  UnsignedLittleEndianIntegerSerializing(
    ...
    SerializingFieldCore<
      Long,?,UnsignedLittleEndianInteger,?,?,?> serializingfieldCore,
    SimplifiedNumberSerializerCore<
      Long,?,UnsignedLittleEndianIntegerSerializing,UnsignedLittleEndianInteger> definitionCore) {
  ...
  @Override
  public UnsignedLittleEndianInteger definition() {
  ...
  @Override
  public SerializingField<Long, UnsignedLittleEndianInteger, ?> packetField() {
