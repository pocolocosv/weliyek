...
public class UnsignedLittleEndianShort
    implements NumberDefinition<
                        Integer,
                        UnsignedLittleEndianShortDeserializing>
{

  public static PacketStructure<
                      Integer,
                      OperationSettings,
                      UnsignedLittleEndianShort,
                      UnsignedLittleEndianShortDeserializing,
                      InputBytestreamGeneralBase<?>,
                      OperationSettings,
                      UnsignedLittleEndianShort,
                      UnsignedLittleEndianShortSerializing,
                      OutputBytestreamGeneralBase<?>,
                      UnsignedLittleEndianShort>
  newPacketStructure(String label) {
    return new PacketStructure<>(
                      label,
                      UnsignedLittleEndianShort::newCore,
  ...
  newCore(ComponentSegmentCore<?,?,?,?,?,?,?,?,?,?> componentCore) {
    return new UnsignedLittleEndianShort(componentCore).definitionCore;
  }
  ...
  private final SimplifiedNumberSerializerCore<
                        ...
                        UnsignedLittleEndianShortDeserializing,
                        UnsignedLittleEndianShortSerializing,
                        UnsignedLittleEndianShort> definitionCore;

  private UnsignedLittleEndianShort(
    ...
    this.definitionCore = new SimplifiedNumberSerializerCore<
                                  ...
                                  UnsignedLittleEndianShort>(
                                      componentCore,
                                      (i,xs,axb,xkc,dc) -> new UnsignedLittleEndianShortDeserializing(i,xs,axb,xkc,dc).operationCore,
                                      LittleEndianUnsignedShortInputSerialization.FACTORY,
                                      (i,y,ys,ayb,ykc,dc) -> new UnsignedLittleEndianShortSerializing(i,y,ys,ayb,ykc,dc).operationCore,
  ...
  public FieldTester<?, ?>
  makeTester(
    Predicate<? super UnsignedLittleEndianShortDeserializing> test,
    String description) {
