...
public final class UnsignedLittleEndianShortDeserializing
                        ...
                        UnsignedLittleEndianShort>
{
  ...
  UnsignedLittleEndianShortDeserializing(
    ...
    DeserializingFieldCore<
      Integer,?,UnsignedLittleEndianShort,?,?,?> packetfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,UnsignedLittleEndianShortDeserializing,?,UnsignedLittleEndianShort> definitionCore) {
  ...
  @Override
  public DeserializingField<Integer, UnsignedLittleEndianShort, ?> packetField() {
