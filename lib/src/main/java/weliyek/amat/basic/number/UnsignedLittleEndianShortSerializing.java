...
public class UnsignedLittleEndianShortSerializing
                        ...
                        UnsignedLittleEndianShort>
{
  ...
  final SimpleNumberSerializerWritingCore<
                        ...
                        UnsignedLittleEndianShort> operationCore;

  public UnsignedLittleEndianShortSerializing(
    int index,
    Integer serializable,
    OperationSettings settings,
    OutputBytestreamGeneralBase<?> parentBytestream,
    SerializingFieldCore<
      Integer,?,UnsignedLittleEndianShort,?,?,?> deserializingfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,?,UnsignedLittleEndianShortSerializing,UnsignedLittleEndianShort> definitionCore) {
    this.operationCore = new SimpleNumberSerializerWritingCore<>(
                                    index,
                                    serializable,
                                    settings,
                                    parentBytestream,
  ...
  @Override
  public UnsignedLittleEndianShort definition() {
  ...
  @Override
  public SerializingField<Integer, UnsignedLittleEndianShort, ?> packetField() {
