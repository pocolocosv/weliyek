...
public final class UnsignedShortBigEndianDeserializing
                        ...
                        UnsignedBigEndianShort>
{
  ...
  UnsignedShortBigEndianDeserializing(
    ...
    DeserializingFieldCore<
      Integer,?,UnsignedBigEndianShort,?,?,?> packetfieldCore,
    SimplifiedNumberSerializerCore<
      Integer,UnsignedShortBigEndianDeserializing,?,UnsignedBigEndianShort> definitionCore) {
  ...
  @Override
  public DeserializingField<Integer, UnsignedBigEndianShort, ?> packetField() {
