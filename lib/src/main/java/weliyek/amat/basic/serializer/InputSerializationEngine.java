...
public abstract class InputSerializationEngine<
                        ...
                        O extends DeserializingOperation<X,?,?,?,?>>
    extends PrimitiveCommonSerializationEngine<QC,O>
{

  private static final Logger logger = LoggerFactory.getLogger(InputSerializationEngine.class);

  protected InputSerializationEngine(
    QC runtimeControl,
    O readingOperation) {
