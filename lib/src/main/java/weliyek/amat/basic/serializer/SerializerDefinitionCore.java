...
public abstract class SerializerDefinitionCore<
                        T,
                        XS extends OperationSettings,
                        XQC extends ReadingRuntimeControl<?,?,?>,
                        XR extends DeserializingResult<T>,
                        XD extends DefinitionSegment<T,XO>,
                        ...
                        DC extends SerializerDefinitionCore<T,XS,XQC,XR,XD,XO,AXB,YS,YQC,YR,YD,YO,AYB,D,?>>
    extends DefinitionSegmentCore<T, XS, XQC, XR, XD, XO, AXB, YS, YQC, YR, YD, YO, AYB, D, DC>
{
  ...
  protected SerializerDefinitionCore(
