...
public abstract class StringFromBytesCore<
                        ...
                        XO extends StringFromBytesReading<XS,? extends DeserializingRuntime<XB>,XR,XD,SXD,SXO>,
                        ...
                        YO extends StringFromBytesWriting<YS,? extends SerializingRuntime<YB>,YR,YD,SYD,SYO>,
    ...
    extends StringFromPrimitiveCore<XS, XB, XBC, XQC, XR, XO, XD, AXB, YS, YB, YBC, YQC, YR, YO, YD, AYB, ByteArrayWrapper, SXS, SXO, SXD, SYS, SYO, SYD, SD, D, DC>
    implements StringFromBytesDefinition<XO, YO, SD>
{

  private final Charset defaultCharset;

  protected StringFromBytesCore(
  ...
  public abstract static class ByteArrayFromStringDisaggregator<
                        YO extends StringFromBytesWriting<?,?,?,?,SD,?>,
                        SD extends ByteArrayDefinition<?>>
  ...
  @Override
  public final SubcomponentHandler<XO, YO, SD> bytes() {
