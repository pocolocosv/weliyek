...
public interface StringFromBytesReading<
                        XS extends OperationSettings,
                        XQ extends DeserializingRuntime<?>,
                        XR extends DeserializingResult<String>,
                        XD extends StringFromBytesDefinition<?,?,? extends SXD>,
                        SXD extends ByteArrayDefinition<SXO>,
                        SXO extends ByteArrayReading<?,?,?,SXD>>
    extends StringFromPrimitiveReading<XS, XQ, XR, XD, ByteArrayWrapper, SXD, SXO>,
            StringFromBytesOperation<
                        XS, XQ, XR, XD,
                        DeserializingField<String,XD,?>,
                        SXO,
                        DeserializingField<ByteArrayWrapper,SXD,SXO>,
                        DeserializingSubfieldHandler<ByteArrayWrapper,SXD,SXO>>
{
