...
public abstract class StringFromPrimitiveCore<
                        ...
                        XO extends StringFromPrimitiveReading<XS,? extends DeserializingRuntime<XB>,XR,XD,ST,SXD,SXO>,
                        ...
                        YO extends StringFromPrimitiveWriting<YS,? extends SerializingRuntime<YB>,YR,YD,ST,SYD,SYO>,
                        ...
                        SXD extends PrimitiveArrayDefinition<ST,SXO>,
                        SYS extends OperationSettings,
                        SYO extends PrimitiveArrayWriting<ST,SYS,?,?,SYD>,
                        SYD extends PrimitiveArrayDefinition<ST,?>,
                        SD extends PrimitiveArrayDefinition<ST, SXO>,
                        D extends StringFromPrimitiveDefinition<XO,YO,SD>,
                        DC extends StringFromPrimitiveCore<
                                      XS,XB,XBC,XQC,XR,XO,XD,AXB,
                                      YS,YB,YBC,YQC,YR,YO,YD,AYB,
                                      ST,SXS,SXO,SXD,SYS,SYO,SYD,SD,D,?>>
    extends AggregatorDefinitionCore<String, XS, XB, XBC, XQC, XR, XD, XO, AXB, YS, YB, YBC, YQC, YR, YD, YO, AYB, D, DC>
    implements StringFromPrimitiveDefinition<XO, YO, SD>
{

  final SubcomponentHandlerCore<ST,SXS,SXD,SXO,String,XBC,XD,XO,SYS,SYD,SYO,YBC,YD,YO,SD,D>
                primitiveArraySubcomponent;

  final Function<XO, String> primitiveArrayDeserializingStringAggregator;

  protected StringFromPrimitiveCore(
  ...
  public abstract static class PrimitiveArrayDisaggregatorFromString<
                          YO extends StringFromPrimitiveWriting<?,?,?,?,ST,SD,?>,
                          ST extends PrimitiveArrayWrapper<?,?>,
                          SD extends PrimitiveArrayDefinition<ST,?>,
                          WA>
  ...
  */
  ...
  @Override
  public final SubcomponentHandler<XO, YO, SD> primitiveArray() {
