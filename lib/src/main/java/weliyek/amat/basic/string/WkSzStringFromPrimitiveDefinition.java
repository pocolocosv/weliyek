...
public interface WkSzStringFromPrimitiveDefinition<
                        ...
                        YO extends WkSzStringFromPrimitiveWriter<?,?,?,?,?,?,?>,
                        SD extends WkSzPrimitiveArrayDefinition<?,?>>
        extends WkSzStringFromPrimitiveSegment<WkSzStructSubcomponent<XO, YO, SD>>,
                WkSzAggregatorDefinition<String, XO>
{
