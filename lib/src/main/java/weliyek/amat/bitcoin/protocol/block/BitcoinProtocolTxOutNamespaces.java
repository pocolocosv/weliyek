...
public class BitcoinProtocolTxOutNamespaces
        extends AmatNamespace
{

    public final AmatNamespace value;
    public final BitcoinProtocolScriptNamespaces script;

    protected BitcoinProtocolTxOutNamespaces(AmatNamespace parentNamespace) {
        super(parentNamespace, BitcoinProtocolName.TXOUT, parentNamespace.factory());
        value = newChildNamespace(BitcoinProtocolName.TXOUT_VALUE);
