...
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgAddrTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgGetBlocksTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgGetDataTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgHeadersTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgNotFoundTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgRejectTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgTxTools;
import weliyek.amat.bitcoin.protocol.message.payload.BitcoinMsgVersionTools;
