...
public abstract class BitcoinMsgNotFoundKernelAbstract
                            <XB extends MessageUnpackedBody<?,?,?>,
                             XK extends BitcoinMsgNotFoundKernelAbstract<XB,XK>>
        extends PayloadListCoreKernelAbstract<BitcoinInventoryVector, XB, XK>
        implements BitcoinMsgNotFound
{

    public BitcoinMsgNotFoundKernelAbstract(PayloadCoreKernelCommissioner<XB, XK> c) {
        super(c);
    }
