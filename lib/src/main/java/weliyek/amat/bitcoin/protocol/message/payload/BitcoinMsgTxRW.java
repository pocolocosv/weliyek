...
public interface BitcoinMsgTxRW
        extends BitcoinMsgTx, BitcoinMsgPayloadRW
{

    void setVersion(int v);

    void setLocktime(long t);

    @Override
    List<BitcoinProtocolTxInRW> txInList();

    @Override
    List<BitcoinProtocolTxOutRW> txOutList();
