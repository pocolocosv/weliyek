...
public class ByteArrayWrapper
    extends PrimitiveArrayWrapperBase<byte[], ByteArrayWrapper>
{
  ...
  private static final WrapperSupplier<byte[], ByteArrayWrapper> wrapperSupplier = ByteArrayWrapper::new;
  ...
  public ByteArrayWrapper(byte[] array, int from, int to) {
  ...
  @Override
  protected final WrapperSupplier<byte[], ByteArrayWrapper> getWrapperSupplier() {
