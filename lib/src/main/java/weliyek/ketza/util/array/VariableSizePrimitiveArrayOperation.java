...
public interface VariableSizePrimitiveArrayOperation<
                        S extends OperationSettings,
                        Q extends SequenceCommonOperationRuntime<?>,
                        R extends OperationResult,
                        D extends VariableSizePrimitiveArrayDefinition<?,?>,
                        K extends FieldSegment<?,?,?>>
    extends VariableSizePrimitiveArraySegment,
            VariableSizeSequenceOperation<S, Q, R, D, K>,
