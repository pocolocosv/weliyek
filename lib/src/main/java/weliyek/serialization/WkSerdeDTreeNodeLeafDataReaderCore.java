...
public abstract class WkSerdeDTreeNodeLeafDataReaderCore<
                        X,
                        ...
                        XOC extends WkSerdeDTreeNodeLeafDataReaderCore<X,XS,XQ,XQC,XR,XO,?,XD,AXB,DC>,
        ...
        extends WkSerdeDTreeNodeDataReaderCore<X, XS, XQ, XQC, XR, XO, XOC, XD, AXB, DC>
{
    ...
    protected WkSerdeDTreeNodeLeafDataReaderCore(
        int index,
        XS settings,
