...
/**
 * Base implementation shared by the input and output {@link WkSerdeDtreeBytestream} types.
 * 
 * @param <S> {@link InputStream} or {@link OutputStream}.
 * @param <B>
 */
public abstract class WkSerdeDtreeBytestreamBase<
                        S,
                        B extends WkSerdeDtreeBytestream>
        implements WkSerdeDtreeBytestream
{

  private final long startIndex;
  private long endIndex = -1;

  protected WkSerdeDtreeBytestreamBase(final long startPos) {
