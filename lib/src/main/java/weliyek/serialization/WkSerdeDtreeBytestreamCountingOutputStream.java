...
public class WkSerdeDtreeBytestreamCountingOutputStream
        extends WkSerdeDtreeBytestreamOutputStreamWrapper<
                        OutputStream,
                        CountingOutputStream,
                        WkSerdeDtreeBytestreamOutput>
{

  public WkSerdeDtreeBytestreamCountingOutputStream(OutputStream output) {
    super(
        () -> output,
