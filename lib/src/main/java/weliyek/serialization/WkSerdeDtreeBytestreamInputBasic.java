...
public final class WkSerdeDtreeBytestreamInputBasic
    extends WkSerdeDtreeBytestreamInputBase<WkSerdeDtreeBytestreamInput>
{

    private final WkSerdeDtreeBytestreamInputBase<?> parent;

    public WkSerdeDtreeBytestreamInputBasic(WkSerdeDtreeBytestreamInputBase<?> parentInputBytestream) {
