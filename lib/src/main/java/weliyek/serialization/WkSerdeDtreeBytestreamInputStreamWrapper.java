...
public abstract class WkSerdeDtreeBytestreamInputStreamWrapper<
                        AS extends InputStream,
                        S extends InputStream,
                        B extends WkSerdeDtreeBytestreamInput>
        extends WkSerdeDtreeBytestreamInputBase<B>
{

  private final S inputstream;
  private final boolean doCloseStream;

  protected WkSerdeDtreeBytestreamInputStreamWrapper(
