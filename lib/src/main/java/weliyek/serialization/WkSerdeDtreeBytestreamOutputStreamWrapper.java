...
public abstract class WkSerdeDtreeBytestreamOutputStreamWrapper<
                        AS extends OutputStream,
                        S extends OutputStream,
                        B extends WkSerdeDtreeBytestreamOutput>
        extends WkSerdeDtreeBytestreamOutputBase<B>
{
   ...
   *                             this object.
   */
  protected WkSerdeDtreeBytestreamOutputStreamWrapper(
