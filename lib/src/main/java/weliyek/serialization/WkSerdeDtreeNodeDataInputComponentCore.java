...
public abstract class WkSerdeDtreeNodeDataInputComponentCore<
                        T,
                        XS extends WkSerdeDtreeOperationSettings,
                        XD extends WkSerdeDtreeNodeStructDefinition<T>,
                        XO extends WkSerdeDtreeNodeDataReader<
                                        T,XS,?,? extends WkSerdeDtreeOperationResult<T>,XD>,
    ...
    extends WkSerdeDtreeNodeDataComponentCore<
                        T, XS, XD,
                        WkSerdeDtreeNodeStructComponentCore<T,XS,XD,XO,AXBC,?,?,?,?,? extends XD>,
                        XO,
                        WkSerdeDtreeNodeDataReaderCore<?,?,?,?,?,XO,?,XD,?,?>,
                        WkSerdeDtreeNodeDataInputComponent<T,XD,XO>,
                        AXBC,
                        WkSerdeDtreeAggregatorReaderCore<?,?,?,AXBC,?,?,?,?,AXO,?,?,?>>
    implements WkSerdeDtreeNodeDataInputComponent<T,XD,XO>
{

  private boolean requiredByFilter;

  protected WkSerdeDtreeNodeDataInputComponentCore(
    int initialOperationListCapacity,
    WkSerdeDtreeNodeStructComponentCore<T,XS,XD,XO,AXBC,?,?,?,?,? extends XD> protocolHandler) {
    super(
        initialOperationListCapacity,
        protocolHandler,
        WkSerdeDtreeNodeDataInputComponentCore::getDeserializedFromReadingOp);
  }
  ...
  newOperation(int index) {
    ...
    final WkSerdeDtreeNodeStructComponentCore<T,XS,XD,XO,AXBC,?,?,?,?,? extends XD> componentCore = protocolFieldCore();
  ...
  private static
  <XX,
   OO extends WkSerdeDtreeNodeDataReader<?,?,?,? extends WkSerdeDtreeOperationResult<XX>,?>>
