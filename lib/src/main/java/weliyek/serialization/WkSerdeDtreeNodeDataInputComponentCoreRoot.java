...
public final class WkSerdeDtreeNodeDataInputComponentCoreRoot<
                        T,
                        XS extends WkSerdeDtreeOperationSettings,
                        XD extends WkSerdeDtreeNodeStructDefinition<T>,
                        XO extends WkSerdeDtreeNodeDataReader<T,XS,?,? extends WkSerdeDtreeOperationResult<T>,XD>,
                        AXBC extends WkSerdeDtreeBytestreamInputBase<?>>
    extends WkSerdeDtreeNodeDataInputComponentCore<
                        T, XS, XD, XO, AXBC,
                        WkSerdeDtreeAggregatorReader<?,?,? extends WkSerdeDtreeOperationInputRuntime<?>,?,?>>
    implements WkSzInputPacket<T, XD, XO>
{
  ...
  public WkSerdeDtreeNodeDataInputComponentCoreRoot(
...
public Optional<WkSerdeDtreeNodeDataOperation<?,?,?,?,?>> previousProcessingSteapResult() {
  ...
  */
  ...
  @Override
  protected WkSerdeDtreeAggregatorReaderCore<?,?,?,AXBC,?,?,?,?,WkSerdeDtreeAggregatorReader<?,?,? extends WkSerdeDtreeOperationInputRuntime<?>,?,?>,?,?,?>
  parentOperationCore() {
    return null;
  }
