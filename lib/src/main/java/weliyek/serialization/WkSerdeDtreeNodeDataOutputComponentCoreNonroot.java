...
public class WkSerdeDtreeNodeDataOutputComponentCoreNonroot<
                        T,
                        ...
                        AYO extends WkSerdeDtreeAggregatorWriter<AY,?,? extends WkSerdeDtreeOperationOutputRuntime<?>,?,?>>
        extends WkSerdeDtreeNodeDataOutputComponentCore<T, YS, YD, YO, AYBC, AYO>
{

  private final WkSrlzOutputPacketSubfieldFrameNodeCore<T,YS,YD,YO,AY,AYBC,?,AYO> myHandler;

  WkSerdeDtreeNodeDataOutputComponentCoreNonroot(
  ...
  @Override
  public WkSerdeDtreeNodeDataOutputComponent<T, YD, YO> asPacket() {
    return this;
  }
