 ...
 * type {@link WkSerdeDtreeNodeStructComponentCoreRoot} does not have a parent.
 * 
 * @param <T>
 * @param <XS>
 * @param <XD>
 ...
 * @param <D>
 */
public class WkSerdeDtreeNodeStructComponentCoreNonRoot<
                        T,
    ...
    extends WkSerdeDtreeNodeStructComponentCore<T, XS, XD, XO, AXBC, YS, YD, YO, AYBC, D>
{

  private final WkSerdeDtreeNodeStructDefinitionCore<?,?,?,?,?,?,?,?,?,?,?,?,?,?,?> parentDefinitionCore;

  WkSerdeDtreeNodeStructComponentCoreNonRoot(
    String label,
