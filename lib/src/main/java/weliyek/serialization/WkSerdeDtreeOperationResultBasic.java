...
public class WkSerdeDtreeOperationResultBasic<X>
  implements WkSerdeDtreeOperationResult<X>
{

    private static final Logger logger = LoggerFactory.getLogger(WkSerdeDtreeOperationResultBasic.class);
