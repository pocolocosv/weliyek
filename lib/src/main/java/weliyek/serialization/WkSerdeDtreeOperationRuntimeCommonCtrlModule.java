...
public abstract class WkSerdeDtreeOperationRuntimeCommonCtrlModule<
                        AB extends WkSerdeDtreeBytestream,
                        B extends WkSerdeDtreeBytestream,
                        BC extends WkSerdeDtreeBytestreamBase<?,B>,
                        Q extends WkSerdeDtreeOperationRuntimeCommon<B>>
        implements WkSerdeDtreeOperationRuntimeCommonCtrl<B, BC, Q>
{
    ...
    protected WkSerdeDtreeOperationRuntimeCommonCtrlModule(
      Q runtimeBody,
      AB parentBytestream,
