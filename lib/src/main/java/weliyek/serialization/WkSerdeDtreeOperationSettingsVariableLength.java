...
public interface WkSerdeDtreeOperationSettingsVariableLength extends WkSerdeDtreeOperationSettings
{
  ...
  builderWithLength(int length) {
    return new WkOperationSettingsFactory<AO, WkSerdeDtreeOperationSettingsVariableLength>() {
      @Override
      public WkSerdeDtreeOperationSettingsVariableLength newSettings(int i, AO parentOperation) {
        return WkSerdeDtreeOperationSettingsVariableLength.withLength(length);
      }
    };
  }

  static WkSerdeDtreeOperationSettingsVariableLength withLength(int length) {
    return new WkSerdeDtreeOperationSettingsVariableLength() {
