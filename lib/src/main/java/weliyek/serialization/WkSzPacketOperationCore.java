...
public abstract class WkSzPacketOperationCore<
                        ...
                        OC extends WkSzPacketOperationCore<S,Q,QC,R,_D,DC,O,?,AB,K,KC>,
                   ...
                   WkSzPacketOperation<S,Q,R,_D,K>
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(WkSzPacketOperationCore.class);
    ...
    protected WkSzPacketOperationCore(
            int index,
            S settings,
            AB parentBytestream,
            KC packetCore,
