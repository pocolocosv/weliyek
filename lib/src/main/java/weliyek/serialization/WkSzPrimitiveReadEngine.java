...
public abstract class WkSzPrimitiveReadEngine<X extends Number>
                        ...
                        WkSzNumberReader<X,?,?,?,?>>
{
  ...
  private static final Logger logger = LoggerFactory.getLogger(WkSzPrimitiveReadEngine.class);

  private X deserializedNumber;

  protected WkSzPrimitiveReadEngine(
