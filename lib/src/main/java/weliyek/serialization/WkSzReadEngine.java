...
public abstract class WkSzReadEngine<
                        X,
                        QC extends WkSzReadingRuntimeControl<?,?,?>,
                        O extends WkSzPacketReaderOperation<X,?,?,?,?>>
    extends WkSzEngineBase<QC,O>
{

  private static final Logger logger = LoggerFactory.getLogger(WkSzReadEngine.class);

  protected WkSzReadEngine(
    QC runtimeControl,
    O readingOperation) {
