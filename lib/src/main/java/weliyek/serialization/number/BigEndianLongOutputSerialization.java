...
import weliyek.serialization.sequence.LongPrimitiveOutputSerializationRule;

public final class BigEndianLongOutputSerialization
    extends LongPrimitiveOutputSerializationRule
{

  public static final BasicPrimitiveSerializerFactory<Long> FACTORY =
      new BasicPrimitiveSerializerFactory<>("SINT64BE", BigEndianLongOutputSerialization::new);
