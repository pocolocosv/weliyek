...
public final class BigEndianUnsignedShortInputSerialization
    extends IntPrimitiveInputSerializationRule<Integer>
{
  ...
  public static BasicPrimitiveDeserializerFactory<Integer> FACTORY =
      new BasicPrimitiveDeserializerFactory<>(
              "UINT16BE",
              BigEndianUnsignedShortInputSerialization::new);

  private BigEndianUnsignedShortInputSerialization(
