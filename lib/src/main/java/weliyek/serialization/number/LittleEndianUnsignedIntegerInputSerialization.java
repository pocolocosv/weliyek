...
import weliyek.serialization.BasicPrimitiveDeserializerFactory;
import weliyek.serialization.WkSzReadingRuntimeControl;

public final class LittleEndianUnsignedIntegerInputSerialization
    extends LongPrimitiveInputSerializationRule
{
  ...
  public static BasicPrimitiveDeserializerFactory<Long> FACTORY =
      new BasicPrimitiveDeserializerFactory<>(
              "UINT32LE",
              LittleEndianUnsignedIntegerInputSerialization::new);

  private LittleEndianUnsignedIntegerInputSerialization(
  ...
  protected long readPrimitiveAsLong() throws IOException {
    return 0xFFFF_FFFFL & readLittleEndianInt();
  }
