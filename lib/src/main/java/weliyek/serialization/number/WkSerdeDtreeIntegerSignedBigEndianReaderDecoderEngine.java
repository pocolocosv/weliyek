...
public final class WkSerdeDtreeIntegerSignedBigEndianReaderDecoderEngine
    extends WkSerdeDtreeIntPrimitiveReaderDecoderEngine<Integer>
{
  ...
  public static WkSerdeDtreePrimitiveDecoderEngineFactory<Integer> FACTORY =
      new WkSerdeDtreePrimitiveDecoderEngineFactory<>(
              "SINT32BE",
              WkSerdeDtreeIntegerSignedBigEndianReaderDecoderEngine::new);

  private WkSerdeDtreeIntegerSignedBigEndianReaderDecoderEngine(
