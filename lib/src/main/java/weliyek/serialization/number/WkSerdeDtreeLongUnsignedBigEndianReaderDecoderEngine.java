...
public final class WkSerdeDtreeLongUnsignedBigEndianReaderDecoderEngine
    extends WkSerdeDtreeLongPrimitiveReaderDecoderEngine
{
  ...
  public static WkSerdeDtreePrimitiveDecoderEngineFactory<Long> FACTORY =
      new WkSerdeDtreePrimitiveDecoderEngineFactory<>(
              "UINT32BE",
              WkSerdeDtreeLongUnsignedBigEndianReaderDecoderEngine::new);

  private WkSerdeDtreeLongUnsignedBigEndianReaderDecoderEngine(
