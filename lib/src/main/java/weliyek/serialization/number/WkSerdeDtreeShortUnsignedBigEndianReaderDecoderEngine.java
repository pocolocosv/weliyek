...
public final class WkSerdeDtreeShortUnsignedBigEndianReaderDecoderEngine
    extends WkSerdeDtreeIntPrimitiveReaderDecoderEngine<Integer>
{
  ...
  public static WkSzPrimitiveReadEngineFactory<Integer> FACTORY =
      new WkSzPrimitiveReadEngineFactory<>(
              "UINT16BE",
              WkSerdeDtreeShortUnsignedBigEndianReaderDecoderEngine::new);

  private WkSerdeDtreeShortUnsignedBigEndianReaderDecoderEngine(
