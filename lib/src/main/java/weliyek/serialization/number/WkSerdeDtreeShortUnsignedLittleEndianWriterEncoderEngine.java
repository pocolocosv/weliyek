...
public class WkSerdeDtreeShortUnsignedLittleEndianWriterEncoderEngine
    extends WkSerdeDtreePrimitiveWriterEncoderEngine<Integer>
{
  ...
  public static final WkSerdeDtreePrimitiveEncoderEngineFactory<Integer> FACTORY =
      new WkSerdeDtreePrimitiveEncoderEngineFactory<>("UINT16LE", WkSerdeDtreeShortUnsignedLittleEndianWriterEncoderEngine::new);

  private WkSerdeDtreeShortUnsignedLittleEndianWriterEncoderEngine(
