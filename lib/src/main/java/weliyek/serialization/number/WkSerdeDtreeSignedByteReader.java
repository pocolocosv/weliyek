...
public final class WkSerdeDtreeSignedByteReader
                        ...
                        WkSerdeDtreeSignedByte>
{
    ...
    final WkSimplifiedNumberSrlzInputPacketDecoderFrameLeafNodeCore<
                        ...
                        WkSerdeDtreeSignedByte> operationCore;

    WkSerdeDtreeSignedByteReader(
      int index,
      WkSettingsSrlzPacketOperationData settings,
      WkSzInputBytestreamBase<?> parentBytestream,
      WkSrlzInputPacketFieldFrameNodeCore<Byte,?,WkSerdeDtreeSignedByte,?,?,?> readingfieldCore,
      WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
        Byte,WkSerdeDtreeSignedByteReader,?,WkSerdeDtreeSignedByte> definitionCore) {
      operationCore = new WkSimplifiedNumberSrlzInputPacketDecoderFrameLeafNodeCore<
                            Byte, WkSerdeDtreeSignedByteReader, WkSerdeDtreeSignedByte>(
                                index,
                                settings,
                                parentBytestream,
                                readingfieldCore,
    ...
    @Override
    public WkSrlzInputPacketFieldFrameNode<Byte, WkSerdeDtreeSignedByte, ?> packetField() {
