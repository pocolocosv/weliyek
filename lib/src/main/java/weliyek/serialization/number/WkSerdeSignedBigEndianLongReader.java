...
public final class WkSerdeSignedBigEndianLongReader
                        ...
                        WkSerdeSignedBigEndianLong>
{
  ...
  WkSerdeSignedBigEndianLongReader(
    ...
    WkSerdeDtreeNodeDataInputComponentCore<
      Long,?,WkSerdeSignedBigEndianLong,?,?,?> deserializingfieldCore,
  ...
  @Override
  public WkSerdeDtreeNodeDataInputComponent<Long, WkSerdeSignedBigEndianLong, ?> packetField() {
    return this.operationCore.packet();
  }

  @Override
  public WkSerdeSignedBigEndianLong definition() {
