                        ...
                        WkSerdeUnsignedByte>
{
    ...
    WkSerdeUnsignedByteReader(
      ...
      WkSrlzInputPacketFieldFrameNodeCore<Integer,?,WkSerdeUnsignedByte,?,?,?> readingfieldCore,
    ...
    @Override
    public WkSrlzInputPacketFieldFrameNode<Integer, WkSerdeUnsignedByte, ?> packetField() {
