                        ...
                        WkSignedBigEndianIntegerSrlzStructNode>
{
  ...
  WkSignedBigEndianIntegerSrlzInputNode(
    ...
    WkSrlzInputPacketFieldFrameNodeCore<
      Integer,?,WkSignedBigEndianIntegerSrlzStructNode,?,?,?> deserializingfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Integer,WkSignedBigEndianIntegerSrlzInputNode,?,WkSignedBigEndianIntegerSrlzStructNode> definitionCore) {
  ...
  @Override
  public WkSrlzInputPacketFieldFrameNode<Integer, WkSignedBigEndianIntegerSrlzStructNode, ?> packetField() {
