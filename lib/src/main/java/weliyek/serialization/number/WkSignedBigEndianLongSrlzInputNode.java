...
public final class WkSignedBigEndianLongSrlzInputNode
                        ...
                        WkSignedBigEndianLongSrlzStructNode>
{
  ...
  WkSignedBigEndianLongSrlzInputNode(
    ...
    WkSrlzInputPacketFieldFrameNodeCore<
      Long,?,WkSignedBigEndianLongSrlzStructNode,?,?,?> deserializingfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Long,WkSignedBigEndianLongSrlzInputNode,?,WkSignedBigEndianLongSrlzStructNode> definitionCore) {
  ...
  @Override
  public WkSrlzInputPacketFieldFrameNode<Long, WkSignedBigEndianLongSrlzStructNode, ?> packetField() {
