...
public final class WkSignedLittleEndianIntegerSrlzInputNode
                        ...
                        WkSignedLittleEndianIntegerSrlzStructNode>
{
  ...
  WkSignedLittleEndianIntegerSrlzInputNode(
    ...
    WkSrlzInputPacketFieldFrameNodeCore<
      Integer,?,WkSignedLittleEndianIntegerSrlzStructNode,?,?,?> deserializingfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Integer,WkSignedLittleEndianIntegerSrlzInputNode,?,WkSignedLittleEndianIntegerSrlzStructNode> definitionCore) {
  ...
  @Override
  public WkSrlzInputPacketFieldFrameNode<Integer, WkSignedLittleEndianIntegerSrlzStructNode, ?> packetField() {
