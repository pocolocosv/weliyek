...
public final class WkSignedLittleEndianLongSrlzInputNode
                        ...
                        WkSignedLittleEndianLongSrlzStructNode>
{
  ...
  WkSignedLittleEndianLongSrlzInputNode(
    ...
    WkSrlzInputPacketFieldFrameNodeCore<
      Long,?,WkSignedLittleEndianLongSrlzStructNode,?,?,?> deserializingfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Long,WkSignedLittleEndianLongSrlzInputNode,?,WkSignedLittleEndianLongSrlzStructNode> definitionCore) {
  ...
  @Override
  public WkSrlzInputPacketFieldFrameNode<Long, WkSignedLittleEndianLongSrlzStructNode, ?> packetField() {
