...
public final class WkSzBigEndianIntegerWriteEngine
        extends WkSzIntPrimiviteWriteEngine
{

  public static final WkSzPrimitiveWriteEngineFactory<Integer> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("SINT32BE", WkSzBigEndianIntegerWriteEngine::new);

  private WkSzBigEndianIntegerWriteEngine(
