...
public final class WkSzBigEndianLongWriteEngine
    extends WkSzLongPrimitiveWriteEngine
{

  public static final WkSzPrimitiveWriteEngineFactory<Long> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("SINT64BE", WkSzBigEndianLongWriteEngine::new);

  private WkSzBigEndianLongWriteEngine(
