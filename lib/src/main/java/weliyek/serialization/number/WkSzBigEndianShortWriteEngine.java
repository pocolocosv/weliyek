...
public final class WkSzBigEndianShortWriteEngine
    extends WkSzPrimitiveWriteEngine<Short>
{

  public static final WkSzPrimitiveWriteEngineFactory<Short> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("SINT16BE", WkSzBigEndianShortWriteEngine::new);

  private WkSzBigEndianShortWriteEngine(
