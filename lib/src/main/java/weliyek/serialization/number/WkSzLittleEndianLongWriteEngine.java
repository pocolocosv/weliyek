...
import weliyek.serialization.sequence.WkSzLongPrimitiveWriteEngine;

public final class WkSzLittleEndianLongWriteEngine
    extends WkSzLongPrimitiveWriteEngine
{

  public static final WkSzPrimitiveWriteEngineFactory<Long> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("SINT64LE", WkSzLittleEndianLongWriteEngine::new);

  private WkSzLittleEndianLongWriteEngine(
