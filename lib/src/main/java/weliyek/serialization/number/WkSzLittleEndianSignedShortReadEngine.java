...
public final class WkSzLittleEndianSignedShortReadEngine
    extends WkSzIntReadEngine<Short>
{

  public static WkSzPrimitiveReadEngineFactory<Short> FACTORY =
      new WkSzPrimitiveReadEngineFactory<>(
              "SINT16LE",
              WkSzLittleEndianSignedShortReadEngine::new);

  private WkSzLittleEndianSignedShortReadEngine(
