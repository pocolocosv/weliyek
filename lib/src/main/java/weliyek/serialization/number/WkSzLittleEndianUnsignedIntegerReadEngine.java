...
public final class WkSzLittleEndianUnsignedIntegerReadEngine
    extends WkSzLongReadEngine
{

  public static WkSzPrimitiveReadEngineFactory<Long> FACTORY =
      new WkSzPrimitiveReadEngineFactory<>(
              "UINT32LE",
              WkSzLittleEndianUnsignedIntegerReadEngine::new);

  private WkSzLittleEndianUnsignedIntegerReadEngine(
