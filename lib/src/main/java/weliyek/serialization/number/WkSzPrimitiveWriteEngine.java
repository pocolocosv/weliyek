...
public abstract class WkSzPrimitiveWriteEngine<T extends Number>
                        ...
                        WkSzNumberWriter<T,?,?,?,?>>
{
  ...
  private static final Logger logger = LoggerFactory.getLogger(WkSzPrimitiveWriteEngine.class);

  protected WkSzPrimitiveWriteEngine(
