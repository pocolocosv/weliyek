...
public final class WkSzSignedByteReadEngine
    extends WkSzIntReadEngine<Byte>
{

  public static WkSzPrimitiveReadEngineFactory<Byte> FACTORY =
      new WkSzPrimitiveReadEngineFactory<>("SINT8", WkSzSignedByteReadEngine::new);

  public WkSzSignedByteReadEngine(
