...
public final class WkSzSignedByteWriteEngine
    extends WkSzPrimitiveWriteEngine<Byte>
{

  public static final WkSzPrimitiveWriteEngineFactory<Byte> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("SINT8", WkSzSignedByteWriteEngine::new);

  private WkSzSignedByteWriteEngine(
