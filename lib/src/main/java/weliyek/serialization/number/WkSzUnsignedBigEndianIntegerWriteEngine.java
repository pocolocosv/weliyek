...
public class WkSzUnsignedBigEndianIntegerWriteEngine
    extends WkSzPrimitiveWriteEngine<Long>
{

  public static final WkSzPrimitiveWriteEngineFactory<Long> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("UINT32BE", WkSzUnsignedBigEndianIntegerWriteEngine::new);

  private WkSzUnsignedBigEndianIntegerWriteEngine(
