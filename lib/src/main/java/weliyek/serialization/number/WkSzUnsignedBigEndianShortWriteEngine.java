...
public class WkSzUnsignedBigEndianShortWriteEngine
    extends WkSzPrimitiveWriteEngine<Integer>
{

  public static final WkSzPrimitiveWriteEngineFactory<Integer> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("UINT16BE", WkSzUnsignedBigEndianShortWriteEngine::new);

  private WkSzUnsignedBigEndianShortWriteEngine(
