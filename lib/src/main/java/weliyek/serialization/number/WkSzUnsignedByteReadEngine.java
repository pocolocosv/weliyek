...
public final class WkSzUnsignedByteReadEngine
    extends WkSzIntReadEngine<Integer>
{

  public static WkSzPrimitiveReadEngineFactory<Integer> FACTORY =
      new WkSzPrimitiveReadEngineFactory<>("UINT8", WkSzUnsignedByteReadEngine::new);

  private WkSzUnsignedByteReadEngine(
