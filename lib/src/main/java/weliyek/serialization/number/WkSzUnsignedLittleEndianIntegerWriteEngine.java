...
public class WkSzUnsignedLittleEndianIntegerWriteEngine
    extends WkSzPrimitiveWriteEngine<Long>
{

  public static final WkSzPrimitiveWriteEngineFactory<Long> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("UINT32LE", WkSzUnsignedLittleEndianIntegerWriteEngine::new);

  private WkSzUnsignedLittleEndianIntegerWriteEngine(
