...
public class WkSzUnsignedLittleEndianShortWriteEngine
    extends WkSzPrimitiveWriteEngine<Integer>
{

  public static final WkSzPrimitiveWriteEngineFactory<Integer> FACTORY =
      new WkSzPrimitiveWriteEngineFactory<>("UINT16LE", WkSzUnsignedLittleEndianShortWriteEngine::new);

  private WkSzUnsignedLittleEndianShortWriteEngine(
