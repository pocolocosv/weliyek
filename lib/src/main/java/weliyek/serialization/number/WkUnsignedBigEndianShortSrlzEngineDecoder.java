...
public final class WkUnsignedBigEndianShortSrlzEngineDecoder
    extends WkIntSrlzEngineDecoder<Integer>
{
  ...
  public static WkSzPrimitiveReadEngineFactory<Integer> FACTORY =
      new WkSzPrimitiveReadEngineFactory<>(
              "UINT16BE",
              WkUnsignedBigEndianShortSrlzEngineDecoder::new);

  private WkUnsignedBigEndianShortSrlzEngineDecoder(
