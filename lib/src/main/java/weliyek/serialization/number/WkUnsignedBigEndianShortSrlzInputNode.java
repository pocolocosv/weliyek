...
public final class WkUnsignedBigEndianShortSrlzInputNode
                        ...
                        WkUnsignedBigEndianShortSrlzStructNode>
{
  ...
  WkUnsignedBigEndianShortSrlzInputNode(
    ...
    WkSrlzInputPacketFieldFrameNodeCore<
      Integer,?,WkUnsignedBigEndianShortSrlzStructNode,?,?,?> packetfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Integer,WkUnsignedBigEndianShortSrlzInputNode,?,WkUnsignedBigEndianShortSrlzStructNode> definitionCore) {
  ...
  @Override
  public WkSrlzInputPacketFieldFrameNode<Integer, WkUnsignedBigEndianShortSrlzStructNode, ?> packetField() {
