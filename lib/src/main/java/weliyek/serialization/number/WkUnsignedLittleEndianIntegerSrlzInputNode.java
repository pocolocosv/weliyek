...
public final class WkUnsignedLittleEndianIntegerSrlzInputNode
        implements WkNumberSrlzInputPacketDecoderFrameLeafNode<
                        Long,
                        WkSettingsSrlzPacketOperationData,
                        WkDecodingRuntimeSrlzPacketOperationData<WkSzInputBytestream>,
                        WkDecodingResultSrlzPacketOperationData<Long>,
                        WkUnsignedLittleEndianIntegerSrlzStructNode>
{
  ...
  final WkSimplifiedNumberSrlzInputPacketDecoderFrameLeafNodeCore<
                      ...
                      WkUnsignedLittleEndianIntegerSrlzStructNode> operationCore;
  ...
  WkUnsignedLittleEndianIntegerSrlzInputNode(
    ...
    WkSrlzInputPacketFieldFrameNodeCore<
      Long,?,WkUnsignedLittleEndianIntegerSrlzStructNode,?,?,?> deserializingfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Long,WkUnsignedLittleEndianIntegerSrlzInputNode,?,WkUnsignedLittleEndianIntegerSrlzStructNode> definitionCore) {
  ...
  @Override
  public Optional<WkDecodingResultSrlzPacketOperationData<Long>> result() {
  ...
  @Override
  public WkSrlzInputPacketFieldFrameNode<Long, WkUnsignedLittleEndianIntegerSrlzStructNode, ?> packetField() {
    return this.operationCore.packet();
  }

  @Override
  public WkUnsignedLittleEndianIntegerSrlzStructNode definition() {
