                        ...
                        WkUnsignedLittleEndianIntegerSrlzStructNode>
{
  ...
  WkUnsignedLittleEndianIntegerSrlzOutputNode(
    ...
    WkSrlzOutputPacketFieldFrameNodeCore<
      Long,?,WkUnsignedLittleEndianIntegerSrlzStructNode,?,?,?> serializingfieldCore,
    WkNumberSimplifiedSrlzStructDefinitionFrameNodeCore<
      Long,?,WkUnsignedLittleEndianIntegerSrlzOutputNode,WkUnsignedLittleEndianIntegerSrlzStructNode> definitionCore) {
  ...
  @Override
  public WkSrlzOutputPacketFieldFrameNode<Long, WkUnsignedLittleEndianIntegerSrlzStructNode, ?> packetField() {
