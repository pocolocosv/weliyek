...
public abstract class WkBasicShortArraySrlzEngineEncoder
        extends WkBasicPrimitiveArrayWrapperSrlzEngineEncoder<WkShortArray, short[]>
{

  protected WkBasicShortArraySrlzEngineEncoder(
