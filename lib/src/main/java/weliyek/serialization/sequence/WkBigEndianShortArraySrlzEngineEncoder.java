...
public final class WkBigEndianShortArraySrlzEngineEncoder
    extends WkBasicShortArraySrlzEngineEncoder
{
  ...
  public static final WkSzBasicPrimitiveArrayWrapperWriteEngineFactory<WkShortArray> FACTORY =
      new WkSzBasicPrimitiveArrayWrapperWriteEngineFactory<>(
            "B_INT16[]",
            WkBigEndianShortArraySrlzEngineEncoder::new);

  private WkBigEndianShortArraySrlzEngineEncoder(
    WkSequenceEncodingRuntimeSrlzPacketOperationCtrl<?,?,?> runtimeControl,
    WkPrimitiveArraySrlzOutputPacketEncoderFrameLeafNode<? extends WkShortArray,?,?,?,?> writingOperation) {
