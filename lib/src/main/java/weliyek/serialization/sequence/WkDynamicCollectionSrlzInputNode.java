                        ...
                        ZT, ZXO, ZXD, ET, EXS, EXD, EXO, VXS>
{
  ...
  @Override
  public
  Optional<WkSrlzInputPacketFieldFrameNode<T, WkVariableSizeCollectionSrlzStructNode<T, VXS, ?, ET, EXS, EXD, EXO, ?, ?, ?, ?>, WkVariableSizeCollectionSrlzInputNode<T, VXS, ET, EXS, EXD, EXO>>>
  variableSequence() {
