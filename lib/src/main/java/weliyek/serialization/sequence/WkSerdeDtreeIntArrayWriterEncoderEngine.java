...
public abstract class WkSerdeDtreeIntArrayWriterEncoderEngine
    extends WkSerdeDtreePrimitiveArrayWriterEncoderEngineBasic<WkIntArray, int[]>
{

  protected WkSerdeDtreeIntArrayWriterEncoderEngine(
