  ...
  newStruct(
    ...
    WkSrlzStructDefinitionFrameNodeCoreFactory<
      ? extends WkSerdeDtreeStructDefinitionCore<
              ZT,ZXS,?,?,ZXD,?,ZXO,?,WkSerdeDtreeBytestreamInputBase<?>,
              ZYS,?,?,ZYD,?,ZYO,?,WkSerdeDtreeBytestreamOutputBase<?>,
    ...
    this.definitionCore = new WkSerdeDtreeDynamicCollectionDefinitionCore<
                                  ...
                                  WkSerdeDynamicCollection<
                                    ...
                                    ET,EXS,EXD,EXO,EYS,EYD,EYO,ED,VXS,VYS>>(
                                        ...
                                        (i,xs,axb,xkc,xdc) -> new WkSerdeDynamicCollectionReader<T,XS,ZT,ZXS,ZXO,ZXD,ET,EXS,EXD,EXO,VXS>(i,xs,axb,xkc,xdc).operationCore,
                                        //BasicWritingRuntime::new,
                                        //BasicWritingResult::empty,
                                        (i,y,ys,ayb,ykc,ydc) -> new WkSerdeDynamicCollectionWriter<T,YS,ZT,ZYS,ZYO,ZYD,ET,EYS,EYD,EYO,VYS>(i,y,ys,ayb,ykc,ydc).operationCore,
                                        collectionFactory,
                                        collectionClass,
                                        componentCore,
                                        this);
