...
import weliyek.util.array.WkSerdeDtreeGenericPrimitiveArrayWriterCoreSimplified;

public class WkSerdeUtilsPrimitiveArray
{
  ...
  public static void onFixedSizeSerilizingInitialization(
    WkSerdeDtreeGenericPrimitiveArrayWriterCoreSimplified<
