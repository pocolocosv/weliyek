...
public abstract class WkSzLongArrayWrapperWriteEngine
    extends WkSzBasicPrimitiveArrayWrapperWriteEngineBase<LongArrayWrapper, long[]>
{

  protected WkSzLongArrayWrapperWriteEngine(
