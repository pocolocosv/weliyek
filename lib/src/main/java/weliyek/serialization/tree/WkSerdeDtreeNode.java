...
import weliyek.serialization.WkSerdeDtreeMsgInput;
import weliyek.serialization.WkSerdeDtreeMsgOutput;
 ...
 * 
 * <ul>
 *   <li>Structural Node: a tree of objects of type {@link WkSerdeDtreeStruct} that define the
 *       the structure of the type to be serialized including the rules and conditions to be 
 *       followed.</li>
 *   <li>Packet frame: a tree of objects of type {@link WkSerdeDtreeMsg} that perform the
 ...
 *   <ul>
 *     <li>Input packet frame: a tree of objects of type {@link WkSerdeDtreeMsgInput} that
 *         decodes a given data type from a byte stream.</li>
 *     <li>Output packet frame: a tree of objects of type {@link WkSerdeDtreeMsgOutput} that
