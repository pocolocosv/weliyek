...
public class IntArrayWrapper
    extends PrimitiveArrayWrapperBase<int[], IntArrayWrapper>
{
  ...
  private static final WrapperSupplier<int[], IntArrayWrapper> wrapperSupplier = IntArrayWrapper::new;
  private static final SubrangeEqualityComparator<int[]> equalityComparator = Arrays::equals;

  IntArrayWrapper(int[] array, int offset, int to) {
  ...
  @Override
  protected final WrapperSupplier<int[], IntArrayWrapper> getWrapperSupplier() {
