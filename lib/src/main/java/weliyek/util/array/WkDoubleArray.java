...
public class WkDoubleArray
    extends WkPrimitiveArrayBase<double[], WkDoubleArray>
{
  ...
  private static final WrapperSupplier<double[], WkDoubleArray> wrapperSupplier = WkDoubleArray::new;
  private static final SubrangeEqualityComparator<double[]> equalityComparator = Arrays::equals;

  WkDoubleArray(double[] array, int offset, int to) {
  ...
  @Override
  protected final WrapperSupplier<double[], WkDoubleArray> getWrapperSupplier() {
