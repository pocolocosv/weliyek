...
public class WkFloatArray
    extends WkPrimitiveArrayBase<float[], WkFloatArray>
{
  ...
  private static final WrapperSupplier<float[], WkFloatArray> wrapperSupplier = WkFloatArray::new;
  private static final SubrangeEqualityComparator<float[]> equalityComparator = Arrays::equals;

  WkFloatArray(float[] array, int offset, int to) {
  ...
  @Override
  protected final WrapperSupplier<float[], WkFloatArray> getWrapperSupplier() {
