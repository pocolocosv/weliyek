...
public class WkLongArray
    extends WkPrimitiveArrayBase<long[], WkLongArray>
{
  ...
  private static final WrapperSupplier<long[], WkLongArray> wrapperSupplier = WkLongArray::new;
  private static final SubrangeEqualityComparator<long[]> equalityComparator = Arrays::equals;

  WkLongArray(long[] array, int offset, int to) {
  ...
  @Override
  protected final WrapperSupplier<long[], WkLongArray> getWrapperSupplier() {
