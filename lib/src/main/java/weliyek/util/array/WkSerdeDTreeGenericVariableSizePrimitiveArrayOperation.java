...
public interface WkSerdeDTreeGenericVariableSizePrimitiveArrayOperation<
                        S extends WkSettingsSrlzPacketOperationData,
                        Q extends WkCommonSequenceRuntimeSrlzPacketOperationData<?>,
                        R extends WkResultSrlzPacketOperationData<?>,
                        D extends WkSerdeDTreeGenericVariableSizePrimitiveArrayDefinition<?>,
                        K extends WkSerdeDTreeNodeDataComponent<?,?,?>>
    extends WkSerdeDTreeGenericVariableSizePrimitiveArray,
            WkSerdeDTreeVariableSizeSequenceOperation<S, Q, R, D, K>,
            WkSerdeDTreeGenericPrimitiveArrayOperation<S, Q, R, D, K>
{
