...
import weliyek.serialization.WkSerdeDTreePrimitiveArrayOperation;
import weliyek.serialization.sequence.WkCommonSequenceRuntimeSrlzPacketOperationData;

public interface WkSerdeDTreeVariableSizePrimitiveArrayLeafOperation<
                        S extends WkSettingsSrlzPacketOperationData,
                        Q extends WkCommonSequenceRuntimeSrlzPacketOperationData<?>,
                        R extends WkResultSrlzPacketOperationData<?>,
                        D extends WkSerdeDTreeVariableSizePrimitiveArrayLeafDefinition<?>,
                        K extends WkSerdeDTreeNodeDataComponent<?,?,?>>
    extends WkSerdeDTreeVariableSizePrimitiveArrayOperation<S, Q, R, D, K>,
            WkSerdeDTreePrimitiveArrayOperation<S, Q, R, D, K>,
            WkSerdeDTreeVariableSizePrimitiveArrayLeaf
{
