...
public class WkShortArray
    extends WkPrimitiveArrayBase<short[], WkShortArray>
{
  ...
  private static final WrapperSupplier<short[], WkShortArray> wrapperSupplier = WkShortArray::new;
  private static final SubrangeEqualityComparator<short[]> equalityComparator = Arrays::equals;

  WkShortArray(short[] array, int offset, int to) {
  ...
  @Override
  protected final WrapperSupplier<short[], WkShortArray> getWrapperSupplier() {
