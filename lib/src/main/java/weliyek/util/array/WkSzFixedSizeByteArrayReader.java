...
public class WkSzFixedSizeByteArrayReader
    implements WkSzByteArrayReader<
               ...
               WkSzFixedSizePrimitiveArraySerializerReader<
                        WkByteArray,
                        WkSzOperationSettings,
                        WkSzSequenceReadingRuntime<WkSzInputBytestream>,
                        WkSzReadingResult<WkByteArray>,
                        WkSzFixedSizeByteArray>
{
  ...
  final SimplifiedPrimitiveArrayDeserializingCore<
                        ...
                        WkSzOperationSettings,
                        WkSzFixedSizeByteArray,
                        WkSzFixedSizeByteArrayReader> operationCore;
  ...
  WkSzFixedSizeByteArrayReader(
    ...
    WkSzPacketReaderFieldCore<
      WkByteArray,?,WkSzFixedSizeByteArray,?,?,?> deserializingfieldCore,
    SimplifiedPrimitiveArraySerializerCore<
      WkByteArray,WkSzOperationSettings,WkSzFixedSizeByteArrayReader,?,?,WkSzFixedSizeByteArray> definitionCore) {
  ...
  @Override
  public WkSzPacketReaderField<WkByteArray, WkSzFixedSizeByteArray, ?>
      packetField() {
