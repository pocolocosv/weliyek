...
import weliyek.serialization.sequence.WkSzFixedSizeSequenceReader;

public interface WkSzFixedSizePrimitiveArrayReader<
  ...
  extends WkSzPrimitiveArrayReader<X, S, Q, R, D>,
          WkSzFixedSizeSequenceReader<X, S, Q, R, D>,
