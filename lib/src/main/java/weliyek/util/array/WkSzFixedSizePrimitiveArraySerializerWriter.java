...
public interface WkSzFixedSizePrimitiveArraySerializerWriter<
                        Y extends WkPrimitiveArray<?, ?>,
                        S extends WkSzOperationSettings,
                        Q extends WkSzSequenceWritingRuntime<?>,
                        R extends WkSzWritingResult,
                        D extends WkSzFixedSizePrimitiveArraySerializerDefinition<Y,?>>
    extends WkSzFixedSizePrimitiveArrayWriter<Y, S, Q, R, D>,
            WkSzPrimitiveArraySerializerWriter<Y, S, Q, R, D>,
            WkSzFixedSizePrimitiveArraySerializerOperation<
                        S, Q, R, D,
