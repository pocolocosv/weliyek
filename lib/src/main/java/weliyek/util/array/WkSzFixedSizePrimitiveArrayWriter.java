...
import weliyek.serialization.sequence.WkSzFixedSizeSequenceWriter;

public interface WkSzFixedSizePrimitiveArrayWriter<
    ...
    extends WkSzPrimitiveArrayWriter<Y, S, Q, R, D>,
            WkSzFixedSizeSequenceWriter<Y, S, Q, R, D>,
