...
public final class WkSzVariableSizeByteArrayReader
    implements WkSzByteArrayReader<
               ...
               WkSzVariableSizePrimitiveArraySerializerReader<
                        WkByteArray,
                        WkSzVariableLengthOperationSettings,
                        WkSzSequenceReadingRuntime<WkSzInputBytestream>,
                        WkSzReadingResult<WkByteArray>,
                        WkSzVariableSizeByteArray>
{
  ...
  final SimplifiedPrimitiveArrayDeserializingCore<
                    ...
                    WkSzVariableLengthOperationSettings,
                    WkSzVariableSizeByteArray,
                    WkSzVariableSizeByteArrayReader> operationCore;
  ...
  WkSzVariableSizeByteArrayReader(
    ...
    WkSzPacketReaderFieldCore<
      WkByteArray,?,WkSzVariableSizeByteArray,?,?,?> deserializingfieldCore,
    SimplifiedPrimitiveArraySerializerCore<
      WkByteArray,WkSzVariableLengthOperationSettings,WkSzVariableSizeByteArrayReader,?,?,WkSzVariableSizeByteArray> definitionCore) {
  ...
  @Override
  public WkSzVariableSizeByteArray definition() {
  ...
  @Override
  public WkSzPacketReaderField<WkByteArray, WkSzVariableSizeByteArray, ?>
  packetField() {
