                        ...
                        WkSzVariableSizeByteArray>
{
  ...
  final SimplifiedPrimitiveArraySerializingCore<
                    ...
                    WkSzOperationSettings,
                    WkSzVariableSizeByteArray,
                    WkSzVariableSizeByteArrayWriter> operationCore;
  ...
  WkSzVariableSizeByteArrayWriter(
    ...
    WkSzPacketWriterFieldCore<
      WkByteArray,?,WkSzVariableSizeByteArray,?,?,?> serializingfieldCore,
    SimplifiedPrimitiveArraySerializerCore<
      WkByteArray,?,?,WkSzOperationSettings,WkSzVariableSizeByteArrayWriter,WkSzVariableSizeByteArray> definitionCore) {
  ...
  @Override
  public WkSzPacketWriterField<WkByteArray, WkSzVariableSizeByteArray, ?>
  packetField() {
