...
import weliyek.serialization.number.WkSzSignedLittleEndianLong;
import weliyek.serialization.number.WkSzSignedLittleEndianLongReader;
import weliyek.serialization.number.WkSzSignedLittleEndianLongWriter;
import weliyek.serialization.number.WkSzSignedLittleEndianShort;
import weliyek.serialization.number.WkSzSignedLittleEndianShortReader;
import weliyek.serialization.number.WkSzSignedLittleEndianShortWriter;
import weliyek.serialization.number.WkSzUnsignedBigEndianInteger;
import weliyek.serialization.number.WkSzUnsignedBigEndianIntegerReader;
import weliyek.serialization.number.WkSzUnsignedBigEndianIntegerWriter;
import weliyek.serialization.number.WkSzUnsignedBigEndianShort;
import weliyek.serialization.number.WkSzUnsignedBigEndianShortReader;
import weliyek.serialization.number.WkSzUnsignedBigEndianShortWriter;
import weliyek.serialization.number.WkSzUnsignedByte;
import weliyek.serialization.number.WkSzUnsignedByteReader;
import weliyek.serialization.number.WkSzUnsignedByteWriter;
import weliyek.serialization.number.WkSzUnsignedLittleEndianInteger;
import weliyek.serialization.number.WkSzUnsignedLittleEndianIntegerReader;
import weliyek.serialization.number.WkSzUnsignedLittleEndianIntegerWriter;
import weliyek.serialization.number.WkSzUnsignedLittleEndianShort;
import weliyek.serialization.number.WkSzUnsignedLittleEndianShortReader;
import weliyek.serialization.number.WkSzUnsignedLittleEndianShortWriter;
